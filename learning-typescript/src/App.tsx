...
const AppUnconnected: React.FC<IAppDispatchToProps & IAppOwnProps> = ({userType, username, saveUsername, saveUserMessage}): JSX.Element => {
  ...
  return (
    <div className="App">
      Hi, {username ? username : 'Mysterious Entity'}, your user type is {username ? userType : 'Unknown'}
      <p>
        {time.toString()}
      </p>
      <input 
